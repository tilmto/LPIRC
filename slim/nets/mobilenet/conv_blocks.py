...
def hsigmoid(x):
  return tf.nn.relu6(x+3)*0.1666667
...
def expanded_conv(input_tensor,
  ...
  with tf.variable_scope(scope, default_name='expanded_conv') as s, \
    ...
    if se:
    	...
    	net_se = slim.fully_connected(net_se,channel_num,scope='fc_2',activation_fn=hsigmoid,weights_regularizer=slim.l2_regularizer(1e-4))
